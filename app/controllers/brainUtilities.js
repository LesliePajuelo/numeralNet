//------------------------------------------------------------------------------
// BrainJS Neural Network Implementation (v0.7.0 compatible)
// Very simple version for numeralNet project
//
// A module to implement a feedforward neural network with stochastic gradient
// descent learning algorithm. This implementation focuses on simplicity and
// readability over optimization, similar to Nielsen's neural network book.
//------------------------------------------------------------------------------
...
NeuralNetwork.prototype.train = function(data, options) {
  ...
  this.logPeriod = options.logPeriod || this.logPeriod;
...
/**
 * Export the NeuralNetwork constructor.
 * 
 * This module exports a single object containing the NeuralNetwork class,
 * making it compatible with the original brain.js API that the numeralNet
 * project was designed to use.
 */
module.exports = {
